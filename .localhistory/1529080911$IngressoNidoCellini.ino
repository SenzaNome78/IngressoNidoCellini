...
const long tempoTotaleAttesaBadgeXScrittura = 15000; // RITARDO DI 3 SECONDO PER MINUTO
...
void NewBadgeOnIn()
{
	...
	Serial.println(wServer.arg("nome"));
	Serial.println(wServer.arg("ruolo"));
	Serial.println(wServer.arg("sesso"));

	
	if (modScrittura == false)
	{
...
String AttivaModScrittura(String nomeNuovoBadge, String ruoloNuovoBadge, String sessoNuovoBadge)
{
	...
	String msgDiRitorno = ""; // Stringa contenente il messaggio da ritornare al server
		...
		wServer.wServer.send(200, "text / plain", msgDiRitorno);
