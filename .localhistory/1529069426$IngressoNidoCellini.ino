...
int SendDataToWebServer(uint32 userSerial, String ruolo, bool entrata);
...
void RegEntryOnIn()
{
	...
	//{
	//	if (wServer.argName(i) == "idPresenza");
	//	{
	Serial.println(wServer.arg(0));
	Serial.println(wServer.arg(1));
	rfid.SetIdPresenza(uint32(wServer.arg(0)), uint32(wServer.arg(1)));
		//}
	for (int i = 0; i < 3; i++)
	{
