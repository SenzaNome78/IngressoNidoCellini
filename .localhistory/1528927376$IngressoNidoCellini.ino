...
const long tempoTotaleAttesaBadgeXScrittura = 60000; // RITARDO DI 3 SECONDO PER MINUTO
...
void loop()
{
	...
	if (client)
	{
		...
		{
			NuovoUtenteHeader = client.readStringUntil('£');

			if (NuovoUtenteHeader.indexOf("command=reset") != -1)
			{
