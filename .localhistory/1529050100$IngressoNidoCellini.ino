...
int SendDataToWebServer(String userSerial, String ruolo, bool entrata)
{
	...
	Serial.println(entr);
	//String tmpStr = "htt<p://192.168.0.2:80/NidoCellini/src/php/RegEntry.php?seriale=" + userSerial + "&ruolo=" + ruolo + "&entrata=" + entr;
	String tmpStr = "/NidoCellini/src/php/RegEntry.php?seriale=" + userSerial + "&ruolo=" + ruolo + "&entrata=" + entr;

	Serial.println(tmpStr);
	httpC.begin("192.168.0.2", 80, tmpStr); // Apriamo una connessione http verso il server
